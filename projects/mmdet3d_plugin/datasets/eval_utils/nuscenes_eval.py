...
def load_gt(nusc: NuScenes, eval_split: str, box_cls, verbose: bool = False):
    ...
    if verbose:
        logging.info('Loading annotations for {} split from nuScenes version: {}'.format(eval_split, nusc.version))
    ...
    if verbose:
        logging.info("Loaded ground truth annotations for {} samples.".format(len(all_annotations.sample_tokens)))
