...
model = dict(
    ...
    img_backbone=dict(
        ...
        ),  # original DCNv2 will logging.info log when perform load_state_dict
...
ann_file_train=info_root + f"nuscenes_uniad_infos_temporal_train.pkl"
ann_file_val=info_root + f"nuscenes_uniad_infos_temporal_val.pkl"
ann_file_test=info_root + f"nuscenes_uniad_infos_temporal_val.pkl"
